...
import { Waves, Volume2, VolumeX, Play, Pause, Music } from "lucide-react";
...
export function OceanWaves() {
  ...
  const [audio] = useState(new Audio("/sounds/anxiety.mp3"));
      ...
      <div className="relative w-48 h-48">
        ...
        >
          <div className="relative">
            <Music className="w-24 h-24 text-blue-600" />
            <motion.div
              animate={{
                opacity: [0.5, 0.8, 0.5],
              }}
