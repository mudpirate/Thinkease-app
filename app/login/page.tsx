  ...
  return (
    ...
    >
      <Container className="flex flex-col items-center justify-center w-full ">
        <Card className="w-full md:w-5/12 max-w-2xl p-8 md:p-10 bg-white/10 rounded-3xl shadow-2xl   backdrop-blur-lg mt-12">
          <div className="mb-6 text-center ">
            <h1 className="text-2xl md:text-3xl font-extrabold bg-gradient-to-r from-primary to-primary/80 bg-clip-text text-white mb-1 tracking-tight">
              Login
            </h1>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-3">
              <div>
                <label
                  htmlFor="email"
                  className="block text-base text-white font-semibold mb-1"
                >
                  Email
                </label>
