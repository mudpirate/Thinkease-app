      ...
      <Container className="flex flex-col items-center justify-center w-full">
        <Card className="w-full md:w-5/12 max-w-2xl p-8 md:p-10 rounded-3xl shadow-2xl border bg-white/10    backdrop-blur-lg mt-20">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <Button
              className="w-full py-2 text-base rounded-xl border font-bold bg-gradient-to-r from-primary to-primary/80 shadow-md hover:from-primary/80 hover:to-primary"
              size="lg"
              type="submit"
              disabled={loading}
            >
